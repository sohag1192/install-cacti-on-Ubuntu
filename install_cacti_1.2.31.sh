#!/bin/bash
# ============================================================
# Cacti 1.2.31 Installer Script for Ubuntu 20.04/22.04 LTS
...
echo "⬇️ Downloading Cacti 1.2.31..."
wget -qO cacti-1.2.31.tar.gz https://www.cacti.net/downloads/cacti-1.2.31.tar.gz
tar -zxf cacti-1.2.31.tar.gz
rm cacti-1.2.31.tar.gz
rm -f /var/www/html/index.html
mv cacti-1.2.31 /var/www/html/cacti
...
echo "========================================================"
echo "✅ Cacti 1.2.31 installation complete!"
